...
\begin{figure}[ht!]
  \centering
\includegraphics[width=0.75\textwidth]{images/similie-timeline.jpg}
\caption{MIT's SIMILIE Timeline.}
\end{figure} 

\begin{figure}[ht!]
  \centering
\includegraphics[width=0.75\textwidth]{images/knightlab-timeline.jpg}
\caption{Knightlab's Timeline JS}
\end{figure}
...
\begin{figure}[ht!]
  \centering
\includegraphics[width=0.75\textwidth]{images/openstreetmap.jpg}
\caption{OpenStreetMap}
\end{figure}

\begin{figure}[ht!]
  \centering
\includegraphics[width=0.75\textwidth]{images/google-map.jpg}
\caption{Google Map}
\end{figure}
