...
We evaluated the project by creating an online survery with a small number of basic tasks to be completed on the web application in order to test the intuitivity of the user interface.
