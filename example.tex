...
During development the web application was split into seperate parts comprising of the map, timeline, user interface and database. With team members working on different parts so as to spread the work effectively. It was sometimes necessary for a developer to carry out work in another persons area. Though for the most part this did not cause any problems, as long as an effective line of communication was maintained between those two team members. This was usually done in the form of GitHub issues or more informally through Facebook chat or "face-to-face" communication.
...
It was the aim when approaching the User Interface to try and achieve a consistency in the colour scheme and layout to make it as easy as possible for the end user to navigate. Buttons and options were kept to a minimum and functionality was designed to be as intuitive as we could make it.
