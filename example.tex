...
Originally the google maps infoWindow was used to display the metadata to the user, however in the late stages of development this approach proved to be inflexible as any minor changes to the appearance or positioning of these infoWindow’s would prove to be overly complicated, for that reason when a marker was clicked a separate div component was opened shown in fig ? in the section User Interface.
